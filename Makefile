...
PROGRAM3	= run_nfc_util_test
ALLPROGRAMS	= $(PROGRAM1) $(PROGRAM2) $(PROGRAM3)
...
$(PROGRAM3): notification_chain_util.o
	$(CC) $(CFLAGS) test_nfc_util.c notification_chain_util.o -o $@
...
test: $(PROGRAM1) $(PROGRAM3)
	@echo "Testing nfc components is successful when it returns 0."
	@./$(PROGRAM1) &> /dev/null && echo ">>> $$?"
	@echo "Testing nfc utility is successful when it returns 0."
	@./$(PROGRAM3) &> /dev/null && echo ">>> $$?"
